...
class VariableTracker:
    def __init__(self, variable, value, i, j, color=THEME_COLORS[0]):
        self.variable = variable
        self.value = value
        self.color = color

        self.objects = VGroup()
        static_text = Text(variable)
        ...
        self.objects.arrange(RIGHT, buff=0.1)
...
class MatrixMultiplication(Scene):
    def construct(self):
        ...
        for i in range(m1.shape[0]):
            animation_list = []
            animation_list.append(m1.move_highlight_row(i))
        ...
        # self.add(m2.make_highlight_row())
        # self.add(m1.make_highlight_column())
        # m1.teleport_highlight_square(2, 1)
